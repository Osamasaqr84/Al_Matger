package com.example.hossam.al_matger.SecondSubCategry.Fragments;
...
public class MainFragment extends Fragment {
    ...
    private SecondSubCatAdapter firstSubCatAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_main_subcategry2, container, false);
        ...
        subCat_itemViewModel.getData().observe(this, new Observer<ArrayList<SubCat_ItemViewModel>>() {
            ...
            public void onChanged(@Nullable ArrayList<SubCat_ItemViewModel> arrayList) {
                firstSubCatAdapter = new SecondSubCatAdapter(getActivity(),arrayList);
