...
import com.example.hossam.al_matger.databinding.DepartmentPinding4;
...
public class DepartmentAdapter extends RecyclerView.Adapter<DepartmentAdapter.CustomView> {
    ...
    public CustomView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        DepartmentPinding4 departmentPinding = DataBindingUtil.inflate(layoutInflater, R.layout.home4_depart_item,parent,false);
    ...
    class CustomView extends RecyclerView.ViewHolder {
        ...
        DepartmentPinding4 departmentPinding4;

        public CustomView(DepartmentPinding4 cardBinding) {
            super(cardBinding.getRoot());
            this.departmentPinding4 = cardBinding;
        }

        public void bind(DepartmentViewModel departmentViewModel)
        {
            this.departmentPinding4.setDepartmentmodel(departmentViewModel);
            departmentPinding4.executePendingBindings();
        }

        public DepartmentPinding4  getCardBinding()
        {
            return  departmentPinding4;
        }
