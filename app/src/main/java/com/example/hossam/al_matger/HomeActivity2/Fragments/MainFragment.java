package com.example.hossam.al_matger.HomeActivity2.Fragments;
...
import com.example.hossam.al_matger.HomeActivity2.Adapter.CategryAdapter;
import com.example.hossam.al_matger.HomeActivity2.Adapter.DepartmentAdapter;
import com.example.hossam.al_matger.HomeActivity2.Adapter.MoreRateAdapter;
import com.example.hossam.al_matger.HomeActivity2.Adapter.SliderPagerAdapter;
...
public class MainFragment extends Fragment {
    ...
    private CaegrytViewModel caegrytViewModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_main_home2, container, false);
        ...
        caegrytViewModel = new CaegrytViewModel();
        ...
        caegrytViewModel.getData().observe(this, new Observer<ArrayList<CaegrytViewModel>>() {
            @Override
            public void onChanged(@Nullable ArrayList<CaegrytViewModel> arrayList) {

               StaggeredGridLayoutManager staggeredGridLayoutManager=new StaggeredGridLayoutManager(2,StaggeredGridLayoutManager.HORIZONTAL);

               categryAdapter = new CategryAdapter(getActivity(),arrayList);
                   categryrecyclerView.setLayoutManager(staggeredGridLayoutManager);
               categryrecyclerView.setAdapter(categryAdapter);
            }
        });
